...
#this test didn't catch my error!
  ...
  # so weird - passes on pet found, then I add the 'if no pet' loop it passes on pet not found, locally when I run it, the critera as expected are returned, however the test fails it.
